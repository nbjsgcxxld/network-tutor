import { ref, toRefs, watch, onBeforeMount, onMounted, nextTick, defineComponent, createVNode } from "vue";
...
(function(module, exports) {
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      var DataView = getNative(context, "DataView"), Map2 = getNative(context, "Map"), Promise = getNative(context, "Promise"), Set = getNative(context, "Set"), WeakMap = getNative(context, "WeakMap"), nativeCreate = getNative(Object2, "create");
      var metaMap = WeakMap && new WeakMap();
      var realNames = {};
      var dataViewCtorString = toSource(DataView), mapCtorString = toSource(Map2), promiseCtorString = toSource(Promise), setCtorString = toSource(Set), weakMapCtorString = toSource(WeakMap);
      ...
      if (DataView && getTag(new DataView(new ArrayBuffer(1))) != dataViewTag || Map2 && getTag(new Map2()) != mapTag || Promise && getTag(Promise.resolve()) != promiseTag || Set && getTag(new Set()) != setTag || WeakMap && getTag(new WeakMap()) != weakMapTag) {
...
function useCodeEditor(props, ctx) {
  const editorEl = ref();
  const {
    modelValue,
    originalText,
  ...
  function setValueEmitter() {
    ...
    model == null ? void 0 : model.onDidChangeContent(
  ...
  function layoutOverlayWidget(lineNumber, ...positionInfos) {
    const index2 = comments.value.findIndex((comment) => comment.lineNumber === lineNumber);
  ...
  function renderOverlayWidget() {
    ...
    renderedWidget == null ? void 0 : renderedWidget.forEach((comment) => {
  ...
  function buildOverlayWidget(comment) {
    return {
      getId: () => {
...
export { CodeEditor, codeEditorProps, index as default };
