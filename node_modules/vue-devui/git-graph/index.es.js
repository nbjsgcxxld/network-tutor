...
(function(module, exports) {
  (function() {
    ...
    var runInContext = function runInContext2(context) {
      ...
      var Array2 = context.Array, Date2 = context.Date, Error = context.Error, Function2 = context.Function, Math2 = context.Math, Object2 = context.Object, RegExp2 = context.RegExp, String = context.String, TypeError = context.TypeError;
...
class GitGraph$1 {
  ...
  drawDot(x, y, commit) {
    ...
    commitText.onclick = function() {
      const url = commit.customUrl || (options == null ? void 0 : options.commit_url.replace("{commitId}", commit.id));
...
function useGitGraph(props, ctx, isDark) {
  let themeService;
...
export { GitGraph, index as default, gitGraphProps };
