...
export declare const transferBodyState: (props: TTransferBodyProps, ctx: SetupContext) => {
    ...
    dragHighlight: import("vue").Ref<TKey | null, TKey | null>;
    dragOverNodeKey: import("vue").Ref<any, any>;
    dropPosition: import("vue").Ref<number | null, number | null>;
    dragTimer: import("vue").Ref<number, number>;
    dragRef: import("vue").Ref<HTMLElement | null, HTMLElement | null>;
