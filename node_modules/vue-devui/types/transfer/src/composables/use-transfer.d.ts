...
export declare const transferState: (props: TTransferProps, ctx: SetupContext) => {
    ...
    sourceChecked: import("vue").Ref<TKey[], TKey[]>;
    targetChecked: import("vue").Ref<TKey[], TKey[]>;
    sourceDirection: import("vue").Ref<string, string>;
    targetDirection: import("vue").Ref<string, string>;
