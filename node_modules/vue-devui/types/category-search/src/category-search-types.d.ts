...
export declare const categorySearchProps: {
    ...
    beforeTagChange: {
        type: PropType<(tag: ICategorySearchTagItem, searchKey: string, operation: string) => boolean | Promise<boolean>>;
    };
    showSearchCategory: {
...
export declare const categorySearchTagProps: {
    item: {
        type: PropType<ICategorySearchTagItem>;
        default: () => {};
    };
...
export declare const typeMenuProps: {
    tag: {
        type: PropType<ICategorySearchTagItem>;
        default: () => {};
    };
...
export declare const extendIconProps: {
    disabled: {
        type: BooleanConstructor;
        default: boolean;
    };
