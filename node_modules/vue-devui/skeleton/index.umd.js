(function(l,e){typeof exports=="object"&&typeof module!="undefined"?e(exports,require("vue"),require("clipboard")):typeof define=="function"&&define.amd?define(["exports","vue","clipboard"],e):(l=typeof globalThis!="undefined"?globalThis:l||self,e(l.index={},l.Vue))})(this,function(l,e){"use strict";const C={variant:{type:String,default:"square"},size:{type:String,default:"md"}},y={rows:{type:Number,default:3},round:{type:Boolean,default:!1},loading:{type:Boolean,default:!0},showAnimation:{type:Boolean,default:!0}},m=Symbol("round"),f=Symbol("showAnimation");function u(o,n,t){let s=o;return n&&(s+=`__${n}`),t&&(s+=`--${t}`),s}function h(o,n=!1){const t=n?`.devui-${o}`:`devui-${o}`;return{b:()=>u(t),e:a=>a?u(t,a):"",m:a=>a?u(t,"",a):"",em:(a,d)=>a&&d?u(t,a,d):""}}function k(o){const n=h("skeleton-item"),{variant:t,size:s}=e.toRefs(o),i=e.inject(m,void 0),r=e.inject(f,void 0);return{classes:e.computed(()=>({[n.b()]:!0,[n.m(t.value)]:!0,[n.m(s.value)]:t.value!=="square",[n.m("round")]:t.value!=="circle"&&Boolean(i==null?void 0:i.value),[n.m("animation")]:Boolean(r==null?void 0:r.value)}))}}function v(){return e.createVNode("svg",{width:"24px",height:"24px",viewBox:"0 0 24 24",version:"1.1",xmlns:"http://www.w3.org/2000/svg"},[e.createVNode("g",{stroke:"none","stroke-width":"1",fill:"none","fill-rule":"evenodd"},[e.createVNode("g",null,[e.createVNode("rect",{fill:"#d8d8d8",opacity:"0",x:"0",y:"0",width:"24",height:"24"},null),e.createVNode("path",{d:`M17.9783341,3.022 C19.5705758,3.022 20.8816065,4.27616494 20.9732206,5.84628917 L20.9783341,6.022 L20.9783341,15.4777069
            ...
            8.99983414,7.7505 Z`,fill:"#bfbfbf"},null)])])])}var b="",c=e.defineComponent({name:"DSkeletonItem",props:C,setup(o){const{variant:n}=e.toRefs(o),{classes:t}=k(o);return()=>e.createVNode("div",{class:t.value},[n.value==="image"&&e.createVNode(v,null,null)])}}),w="",p=e.defineComponent({name:"DSkeleton",props:y,setup(o,n){const t=h("skeleton"),{loading:s,rows:i,showAnimation:r,round:L}=e.toRefs(o),a=e.computed(()=>new Array(i.value).fill(""));return e.provide(f,r),e.provide(m,L),()=>{var d,g;return s.value?n.slots.placeholder?n.slots.placeholder():e.createVNode("div",{class:t.b()},[e.createVNode(c,{class:t.e("title")},null),a.value.map(()=>e.createVNode(c,{class:t.e("paragraph")},null))]):(g=(d=n.slots).default)==null?void 0:g.call(d)}}}),S={title:"Skeleton \u9AA8\u67B6\u5C4F",category:"\u6570\u636E\u5C55\u793A",status:"100%",install(o){o.component(p.name,p),o.component(c.name,c)}};l.Skeleton=p,l.SkeletonItem=c,l.animationInjectionKey=f,l.default=S,l.roundInjectionKey=m,l.skeletonItemProps=C,l.skeletonProps=y,Object.defineProperties(l,{__esModule:{value:!0},[Symbol.toStringTag]:{value:"Module"}})});
