...
export declare function makeMarkerState(): MarkerState;
export interface UseMarkerReturn {
    makeMarker: (marker: MarkerStyle, isSource: boolean, previousId: string | undefined, strokeColor: string, instanceId: string) => string | undefined;
    clearMarker: (id: string | undefined) => void;
}
export declare function useMarker(markerState: MarkerState): UseMarkerReturn;
