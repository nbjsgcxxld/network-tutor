...
const devuiCustomComponentsThemeData = {
...
const devuiCustomComponentsDarkThemeData = {
  "devui-btn-sm-padding": "0 12px",
  "devui-btn-padding": "0 16px",
  "devui-btn-lg-padding": "0 20px",
...
const infinityTheme = new Theme({
  id: "infinity-theme",
  name: "\u65E0\u9650\u4E3B\u9898",
  data: __spreadValues(__spreadValues(__spreadValues({}, devuiLightTheme.data), devuiInitialThemeData), devuiCustomComponentsThemeData),
  extends: "devui-light-theme",
  isDark: false
});
...
const deepTheme = new Theme({
  id: "deep-theme",
  name: "\u6DF1\u9083\u591C\u7A7A\u4E3B\u9898",
  data: __spreadProps(__spreadValues(__spreadValues({}, infinityTheme.data), devuiCustomComponentsDeepThemeData), {
...
const galaxyTheme = new Theme({
  id: "galaxy-theme",
  name: "\u8FFD\u5149\u4E3B\u9898",
  data: __spreadProps(__spreadValues(__spreadValues({}, devuiDarkTheme.data), devuiCustomComponentsDarkThemeData), {
    "devui-brand": "#526ECC",
    "devui-info": "#526ECC",
